...
class PolizzaCarForm extends Form
{
    public function buildForm()
    {
        ...
        $this->add('works_place', 'select', [
            'choices' => Province::whereIsActive(1)->pluck('name', 'abbr_prov')->toArray(),
            'attr' => ['class' => 'select2 pmd-select2 form-control'],
            'label' => trans('PolizzaCar::PolizzaCar.form.works_place'),
            'empty_value' => trans('core::core.empty_select')
        ]);
        $this->add('primary_works_place', 'select', [
            'choices' => Province::whereIsActive(1)->pluck('name', 'name')->toArray(),
            'attr' => ['class' => 'select2 pmd-select2 form-control'],
            'label' => trans('PolizzaCar::PolizzaCar.form.primary_works_place'),
            'empty_value' => trans('core::core.empty_select')
        ]);
        ...
        $this->add('car_p2_premium_gross', 'static', [
            'wrapper' => ['class' => 'form-group form-line focused'],
            // 'label_show' => false,
            'attr' => ['class' => 'form-control premium_gross'],
            'label' => trans('PolizzaCar::PolizzaCar.form.car_premium_gross'),
        ]);
        $this->add('car_p2_premium_net', 'static', [
            'wrapper' => ['class' => 'form-group form-line focused'],
            //'label_show' => false,
            'attr' => ['class' => 'form-control premium_net'],
            'label' => trans('PolizzaCar::PolizzaCar.form.car_premium_net'),
        ...
        $this->add('car_p3_premium_gross', 'static', [
            'wrapper' => ['class' => 'form-group form-line focused'],
            // 'label_show' => false,
            'attr' => ['class' => 'form-control premium_gross'],
            'label' => trans('PolizzaCar::PolizzaCar.form.car_premium_gross'),
        ]);
        $this->add('car_p3_premium_net', 'static', [
            'wrapper' => ['class' => 'form-group form-line focused'],
            //'label_show' => false,
            'attr' => ['class' => 'form-control premium_net'],  
            'label' => trans('PolizzaCar::PolizzaCar.form.car_premium_net'),
