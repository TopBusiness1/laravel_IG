...
class PolizzaCar extends Model
{
    use SoftDeletes, LogsActivity, Commentable, HasAttachment;
    ...
    protected $dates = ['date_request', 'order_sent_at', 'deleted_at', 'created_at', 'updated_at'];
