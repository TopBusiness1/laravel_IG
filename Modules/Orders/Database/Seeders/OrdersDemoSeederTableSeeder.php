...
class OrdersDemoSeederTableSeeder extends SeederHelper
{
    ...
    public function run()
    {
        ...
        for ($i = 1; $i <= 20; $i++) {
            ...
            $order->bill_state = 'DC';
            // $order->bill_country_id = Country::get()->random(1)->first()->id;
            ...
            $order->ship_state = 'DC';
            // $order->ship_country_id = Country::get()->random(1)->first()->id;
            $order->ship_zip_code = $faker->postcode;

            // $order->order_status_id = OrderStatus::get()->random(1)->first()->id;
            $order->order_status_id = 2;
            // $order->order_carrier_id = OrderCarrier::get()->random(1)->first()->id;
            ...
            // $order->currency_id = Currency::get()->random(1)->first()->id;
            // $order->tax_id = Tax::get()->random(1)->first()->id;
