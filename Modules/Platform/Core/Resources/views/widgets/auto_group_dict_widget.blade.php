...
<div class="{{ $config['coll_class'] }}">
    ...
    <div class="info-box-4 hover-expand-effect bg-{{ $record['color'] }} {{ isset($config['dataTableToFilter']) && $config['dataTableToFilter']  != '' ? "filterable-group-widget pointer": '' }}" data-col-name="{{$config['groupBy']}}" data-name="{{$record['title']}} ">
        <div class="icon">
