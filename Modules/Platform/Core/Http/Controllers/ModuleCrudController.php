...
abstract class ModuleCrudController extends AppBaseController
{
    ...
    public function show($identifier)
    {
        ...
        switch ($user->role_id) {
            case '5': // User
                if ($entity->company_email !=  $user->email) {
                    abort(404);
                }
                break;

            case '4': // Buyer
                if ($entity->group_id !=  $user->group_id) {
                    //abort(404);
                }
                break;
