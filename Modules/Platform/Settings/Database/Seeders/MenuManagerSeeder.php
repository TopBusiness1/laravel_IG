...
class MenuManagerSeeder extends SeederHelper
{
    private static $_CRM_MENU = [
        ...
        [ 'id' => 1, 'order_by' => 1, 'url' => "/dashboard", 'label' => "home", 'icon' => "apps", 'permission' => "", 'parent_id' => null, 'section' => 1, 'visibility' => 1, 'dont_translate' => 0 ],
        [
            'id' => 2,
            'order_by' => 10,
            'url' => "/settings",
        ...
        ['id' => 5, 'order_by' => 5, 'url' => "/orders", 'label' => "orders", 'icon' => "pageview", 'permission' => "orders.browse", 'parent_id' => null, 'section' => 1, 'visibility' => 1, 'dont_translate' => 0],
        ['id' => 6, 'order_by' => 6, 'url' => "/payments", 'label' => "payments", 'icon' => "payment", 'permission' => "payments.browse", 'parent_id' => null, 'section' => 1, 'visibility' => 1, 'dont_translate' => 0]
